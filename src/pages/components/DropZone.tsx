...
import { TranslationPair } from "./TranslationTable";
...
export const DropZone = () => {
  const { translationPairs, setTranslationPairs } = useContext(TranslationContext);
              ...
              for (const file of files) {
                try {
                  ...
                  if (data) {
                    ...
                    // const defs = xml.Defs;
                    // if (!defs) continue;
                    // const defsArray: { key: string; values: any }[] = Object.keys(defs).map((key: string) => {
                    //   return { key: key, values: defs[key] };
                    // });
                    // for (const def of defsArray) {
                    //   const defName = def.values.defName;
                    //   if (!defName) continue;
                    // }
